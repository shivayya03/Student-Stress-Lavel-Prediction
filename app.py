...
if st.button("Predict"):
    ...
    if prediction == 1:
        ...
        st.pyplot(fig)
        st.success(f"✅Hello {name}, your stress level is currently Low. You're doing great! Maintain this balance.")
        ...
        st.pyplot(fig)
        st.warning(f"⚠️ Hello {name}, your stress level is currently medium. Try improving sleep or adding light exercise.")
        ...
        st.pyplot(fig)
        st.error(f"🚨 Hello {name}, your stress level is currently High, talk to someone, or take short breaks.")
